x<-data.frame(x1=c(2959.19, 2459.77, 1495.63, 1046.33, 1303.97, 1730.84, 
       ...
       1608.82),x2=c(730.79, 495.47, 515.90, 477.77, 524.29, 553.90, 492.42, 
       ...
       437.77, 480.99, 536.05),x3=c(749.41, 697.33, 362.37, 290.15, 254.83, 246.91, 200.49, 
       ...
       258.78, 273.84, 432.46),x4=c(513.34, 302.87, 285.32, 208.57, 192.17, 279.81, 218.36, 
       ...
       303.00, 317.32, 235.82),x5=c(467.87, 284.19, 272.95, 201.50, 249.81, 239.18, 220.69, 
       ...
       244.93, 251.08, 250.28),x6=c(1141.82, 735.97, 540.58, 414.72, 463.09, 445.20, 459.62, 
       ...
       479.53, 424.75, 541.30),x7=c(478.42, 570.84, 364.91, 281.84, 287.87, 330.24, 360.48, 
       ...
       288.56, 228.73, 344.85),x8=c(457.64, 305.08, 188.63, 212.10, 192.96, 163.86, 147.76, 
       ...
       236.51, 195.93, 214.40),row.names=c("Beijing","Tianjin","Hebei","shanxi1","neimeng","liaoning", "jilin","heilongjiang","shanghai","jiangsu","zhejiang","Anhui","Fujian", 
              "Jiangxi","Shandong","Henan","Hubei","Hunan","Guangdong","Guangxi","Hainan", "Chongqing","Sichuan","Guizhou","Yunnan","Xizang","Shanxi3","Gansu", 
              "Qinghai","Ningxia","Xinjiang"))
scale<-scale(x,center=FALSE)
hc <- hclust(dist(scale,method="maximum"), "ward.D2")
zz<-dist(scale,method="maximum")
zr<-as.matrix(zz)
write.csv(zr,"zz.csv")
plot(hc,hang=-1)
rect.hclust(hc,k=5)
